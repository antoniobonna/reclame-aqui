...
query_data = "SELECT DISTINCT ano,semana FROM reclame_aqui_dw.vw_reclamacoes_avaliadas WHERE empresa_id = '{}' AND (ano,semana) != (date_part('year',current_date),date_part('week',current_date)) ORDER BY 1,2"
